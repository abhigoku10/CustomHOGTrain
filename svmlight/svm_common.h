...
typedef struct svector {
	MY_WORD   *words;              /* The features/values in the vector by
...
SVECTOR *create_svector(MY_WORD *, char *, double);
...
int    parse_document(char *, MY_WORD *, double *, long *, long *, double *, long *, long, char **);
